...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_invalid_boolean(self):
        """It should not Deserialize with invalid boolean"""
        product = ProductFactory()
    ...
    def test_deserialize_invalid_attribute(self):
        """It should not Deserialize with invalid attribute"""
        product = ProductFactory()
        data = product.serialize()
        data["invalid"] = "something"
        # This should still work as extra attributes are ignored
    ...
    def test_deserialize_bad_data(self):
        """It should not Deserialize with bad data type"""
        product = ProductFactory()
        with self.assertRaises(DataValidationError):
